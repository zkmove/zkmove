...
see [User Guide](https://www.zkmove.net/zkmove/user/setup-dev-environment.html) for a step-by-step tutorial on how to create a zkMove circuit, generate a proof, and verify it on-chain.

see [Litepaper](https://www.zkmove.net/zkmove/litepaper/abstract.html) for an in-depth technical overview of zkMove's design and architecture.
