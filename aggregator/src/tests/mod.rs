...
use simple_vm_circuit::SimpleVmCircuit;
use test_circuit_1::TestCircuit1;
use test_circuit_2::TestCircuit2;

mod app_circuit_aggregation;
pub mod simple_vm_circuit;
pub mod test_circuit_1;
pub mod test_circuit_2;
mod vm_circuit_compression;
