...
type PlonkSuccinctVerifier =
    snark_verifier::verifier::plonk::PlonkSuccinctVerifier<As, LimbsEncoding<LIMBS, BITS>>;
// type PlonkVerifier = snark_verifier::verifier::plonk::PlonkVerifier<As, LimbsEncoding<LIMBS, BITS>>;
type Svk = KzgSuccinctVerifyingKey<G1Affine>;
type BaseFieldEccChip = halo2_ecc::BaseFieldEccChip<G1Affine, LIMBS, BITS>;
