...
The following example demonstrates a small portion of a CA smart contract. It allows a user to prove that their asset balance falls within a given range `[min, max]`, without revealing the actual amount.
