...
use circuit_tool::base_constraint_builder::{BaseConstraintBuilder, ConstraintBuilder};
...
impl<F: Field + Hashable> ExecutionConfig<F> {
    pub fn configure(
        ...
        let (step_curr, base_constraint) = {
            let mut cb = VmConstraintBuilder::new(
                meta,
                &mut cell_columns,
                &challenge_exprs,
                step_curr,
