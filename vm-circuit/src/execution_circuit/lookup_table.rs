use crate::execution_circuit::lookup_table::bitwise_table::BitwiseLookupTable;
use crate::execution_circuit::lookup_table::byecode_table::BytecodeLookupTable;
use crate::execution_circuit::lookup_table::constant_table::ConstantLookupTable;
use crate::execution_circuit::lookup_table::fix_table::FixedTable;
use crate::execution_circuit::lookup_table::function_table::FunctionLookupTable;
use crate::execution_circuit::lookup_table::poseidon_table::PoseidonTable;
use crate::execution_circuit::lookup_table::pow2::Pow2LookupTable;
