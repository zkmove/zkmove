...
impl<F: Field> ShiftGadget<F> {
    fn construct(
        ...
        //
        cb.require_zero("c == 0 for shl".to_string(), c.clone() * is_shl.clone());
        ...
        cb.require_zero(
            "overflow == 0 for opcode shr".to_string(),
