...
use crate::chips::execution_chip::value::Value;
...
pub const OPERAND0: &str = "operand0";
pub const OPERAND1: &str = "operand1";
...
impl<F: Field> Step<F> {
    pub fn new(
        ...
        let state = StepState {
            ...
            operand0: cell_manager.query_cell(meta, cell_manager_columns, CellType::StoragePhase0),
            operand1: cell_manager.query_cell(meta, cell_manager_columns, CellType::StoragePhase0),
