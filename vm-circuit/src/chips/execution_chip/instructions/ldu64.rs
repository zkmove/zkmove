...
impl<F: FieldExt> InstructionGadget<F> for LdU64<F> {
    const NAME: &'static str = "LDU64";
    ...
    fn configure(&self, cells: &StepChipCells<F>, cb: &mut ConstraintBuilder<F>) {
        ...
        LookupBytecode::lookup_bytecode(cb, cells, Opcode::LdU64, self.value_a.expression.clone());
    }
