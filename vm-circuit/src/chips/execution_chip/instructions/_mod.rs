...
impl<F: Field> InstructionGadget<F> for Mod<F> {
    ...
    fn configure(&self, cells: &StepChipCells<F>, cb: &mut ConstraintBuilder<F>) {
        ...
        let expr = MulAddWordsOp {
            ...
            c_hi: self.value_c.hi.expression.clone(),
            c_lo: self.value_c.lo.expression.clone(),
        ...
        LookupBytecode::lookup_bytecode(cb, cells, Opcode::Mod, 0u64.expr());
    }
